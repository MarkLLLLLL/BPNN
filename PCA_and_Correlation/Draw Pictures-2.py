...
for i in range(22,40):
    data1 = xlrd.open_workbook('C:\\Users\\lmz\\Desktop\\NEW2-EDP TEST-3\\%d Ten Stress Strain curve data.xls'%(i))
    table1 = data1.sheets()[0]
    data2 = xlrd.open_workbook('C:\\Users\\lmz\\Desktop\\NEW2-EDP TEST-3\\%d Com Stress Strain curve data.xls'%(i))
    ...
    # plt.legend()
    # plt.show()
    plt.savefig('C:/Users/lmz/Desktop/图片-3/%d Ten Stress Strain curve.png'%(i),
                dpi=400,
                bbox_inches = 'tight',
                facecolor = 'w',
                edgecolor = 'b')
    ...
    # plt.legend()
    # plt.show()
    plt.savefig('C:/Users/lmz/Desktop/图片-3/%d Com Stress Strain curve.png'%(i),
                dpi=400,
                bbox_inches = 'tight',
                facecolor = 'w',
                edgecolor = 'b')
